...
const SERVERS = {
  ...
  "GET /api/images/[key]": (params: { key: (string | number) }) => {
    return `/api/images/${params.key}`
  }
}
...
export type KIT_ROUTES = {
  ...
  SERVERS: { 'GET /api/courses': never, 'DELETE /api/courses/[id]': 'id', 'GET /api/courses/[id]': 'id', 'GET /api/images/[key]': 'key' }
  ...
  Params: { id: never, courseId: never, tutorId: never, key: never, avatarId: never, email: never, phoneNo: never }
}
